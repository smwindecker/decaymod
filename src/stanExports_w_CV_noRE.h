...
namespace model_w_CV_noRE_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_w_CV_noRE");
    ...
    reader.add_event(159, 2, "restart", "model_w_CV_noRE");
    ...
    reader.add_event(238, 3, "restart", "model_w_CV_noRE");
    reader.add_event(299, 62, "end", "model_w_CV_noRE");
    return reader;
}
...
class model_w_CV_noRE
  : public stan::model::model_base_crtp<model_w_CV_noRE> {
private:
        int N;
        int N_test;
        vector_d mT;
        ...
        std::vector<int> sp;
public:
    model_w_CV_noRE(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_w_CV_noRE_namespace::model_w_CV_noRE";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_w_CV_noRE_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            stan::math::assign(neg_loglik, weibull_negloglik(mT_test, m0_test, time_test, beta_pred, alpha_pred, sigma_obs, N_test, pstream__));
            }
...
typedef model_w_CV_noRE_namespace::model_w_CV_noRE stan_model;
#ifndef USING_R
