...
namespace model_ne_noCV_noRE_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_ne_noCV_noRE");
    ...
    reader.add_event(89, 2, "restart", "model_ne_noCV_noRE");
    ...
    reader.add_event(168, 3, "restart", "model_ne_noCV_noRE");
    reader.add_event(209, 42, "end", "model_ne_noCV_noRE");
    return reader;
}
...
class model_ne_noCV_noRE
  : public stan::model::model_base_crtp<model_ne_noCV_noRE> {
private:
        int N;
        vector_d mT;
        vector_d m0;
        ...
        std::vector<int> sp;
public:
    model_ne_noCV_noRE(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_ne_noCV_noRE_namespace::model_ne_noCV_noRE";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_ne_noCV_noRE_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            stan::math::assign(k_fit, param(b, X, P, J, pstream__));
            current_statement_begin__ = 205;
            stan::math::assign(mT_fit, negexp_fit_rng(N, m0, time, k_fit, sp, sigma_obs, base_rng__, pstream__));
...
typedef model_ne_noCV_noRE_namespace::model_ne_noCV_noRE stan_model;
#ifndef USING_R
