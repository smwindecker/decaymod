...
namespace model_ne_CV_noRE_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_ne_CV_noRE");
    ...
    reader.add_event(89, 2, "restart", "model_ne_CV_noRE");
    ...
    reader.add_event(168, 3, "restart", "model_ne_CV_noRE");
    reader.add_event(218, 51, "end", "model_ne_CV_noRE");
    return reader;
}
...
class model_ne_CV_noRE
  : public stan::model::model_base_crtp<model_ne_CV_noRE> {
private:
        int N;
        int N_test;
        vector_d mT;
        ...
        std::vector<int> sp;
public:
    model_ne_CV_noRE(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_ne_CV_noRE_namespace::model_ne_CV_noRE";
        ...
        try {
            ...
            validate_non_negative_index("X_test", "1", 1);
            validate_non_negative_index("X_test", "P", P);
            context__.validate_dims("data initialization", "X_test", "matrix_d", context__.to_vec(1,P));
            X_test = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(1, P);
            vals_r__ = context__.vals_r("X_test");
            pos__ = 0;
            size_t X_test_j_2_max__ = P;
            size_t X_test_j_1_max__ = 1;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(k, param(b, X, P, J, pstream__));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_ne_CV_noRE_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            local_scalar_t__ k_pred(DUMMY_VAR__);
            (void) k_pred;  // dummy to suppress unused var warning
            stan::math::initialize(k_pred, DUMMY_VAR__);
            stan::math::fill(k_pred, DUMMY_VAR__);
            current_statement_begin__ = 212;
            stan::math::assign(k_pred, param_pred(b, X_test, P, pstream__));
            current_statement_begin__ = 213;
            stan::math::assign(mT_pred, negexp_pred_rng(N_test, m0_test, time_test, k_pred, sigma_obs, base_rng__, pstream__));
            current_statement_begin__ = 214;
            stan::math::assign(neg_loglik, negexp_negloglik(mT_test, m0_test, time_test, k_pred, sigma_obs, N_test, pstream__));
            }
...
typedef model_ne_CV_noRE_namespace::model_ne_CV_noRE stan_model;
#ifndef USING_R
