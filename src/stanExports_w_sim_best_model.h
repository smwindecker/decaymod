...
namespace model_w_sim_best_model_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_w_sim_best_model");
    ...
    reader.add_event(159, 2, "restart", "model_w_sim_best_model");
    ...
    reader.add_event(238, 3, "restart", "model_w_sim_best_model");
    reader.add_event(300, 63, "end", "model_w_sim_best_model");
    return reader;
}
...
class model_w_sim_best_model
  : public stan::model::model_base_crtp<model_w_sim_best_model> {
private:
        int N;
        vector_d mT;
        vector_d m0;
        ...
        int P_beta_sim;
        int J_sim;
        matrix_d X_alpha_sim;
        matrix_d X_beta_sim;
        std::vector<int> sp_sim;
public:
    model_w_sim_best_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_w_sim_best_model_namespace::model_w_sim_best_model";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "m0_sim", "double", context__.to_vec());
            m0_sim = double(0);
            vals_r__ = context__.vals_r("m0_sim");
            pos__ = 0;
            m0_sim = vals_r__[pos__++];
            check_greater_or_equal(function__, "m0_sim", m0_sim, 0);
            current_statement_begin__ = 255;
            context__.validate_dims("data initialization", "time_sim", "double", context__.to_vec());
            time_sim = double(0);
            vals_r__ = context__.vals_r("time_sim");
            pos__ = 0;
            time_sim = vals_r__[pos__++];
            check_greater_or_equal(function__, "time_sim", time_sim, 0);
            current_statement_begin__ = 256;
            context__.validate_dims("data initialization", "P_alpha_sim", "int", context__.to_vec());
            P_alpha_sim = int(0);
            vals_i__ = context__.vals_i("P_alpha_sim");
            pos__ = 0;
            P_alpha_sim = vals_i__[pos__++];
            check_greater_or_equal(function__, "P_alpha_sim", P_alpha_sim, 1);
            current_statement_begin__ = 257;
            context__.validate_dims("data initialization", "P_beta_sim", "int", context__.to_vec());
            P_beta_sim = int(0);
            vals_i__ = context__.vals_i("P_beta_sim");
            pos__ = 0;
            P_beta_sim = vals_i__[pos__++];
            check_greater_or_equal(function__, "P_beta_sim", P_beta_sim, 1);
            current_statement_begin__ = 258;
            context__.validate_dims("data initialization", "J_sim", "int", context__.to_vec());
            J_sim = int(0);
            vals_i__ = context__.vals_i("J_sim");
            pos__ = 0;
            J_sim = vals_i__[pos__++];
            check_greater_or_equal(function__, "J_sim", J_sim, 1);
            current_statement_begin__ = 259;
            validate_non_negative_index("X_alpha_sim", "J_sim", J_sim);
            validate_non_negative_index("X_alpha_sim", "P_alpha_sim", P_alpha_sim);
            context__.validate_dims("data initialization", "X_alpha_sim", "matrix_d", context__.to_vec(J_sim,P_alpha_sim));
            X_alpha_sim = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(J_sim, P_alpha_sim);
            vals_r__ = context__.vals_r("X_alpha_sim");
            pos__ = 0;
            size_t X_alpha_sim_j_2_max__ = P_alpha_sim;
            size_t X_alpha_sim_j_1_max__ = J_sim;
            for (size_t j_2__ = 0; j_2__ < X_alpha_sim_j_2_max__; ++j_2__) {
                for (size_t j_1__ = 0; j_1__ < X_alpha_sim_j_1_max__; ++j_1__) {
                    X_alpha_sim(j_1__, j_2__) = vals_r__[pos__++];
                }
            }
            current_statement_begin__ = 260;
            validate_non_negative_index("X_beta_sim", "J_sim", J_sim);
            validate_non_negative_index("X_beta_sim", "P_beta_sim", P_beta_sim);
            context__.validate_dims("data initialization", "X_beta_sim", "matrix_d", context__.to_vec(J_sim,P_beta_sim));
            X_beta_sim = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(J_sim, P_beta_sim);
            vals_r__ = context__.vals_r("X_beta_sim");
            pos__ = 0;
            size_t X_beta_sim_j_2_max__ = P_beta_sim;
            size_t X_beta_sim_j_1_max__ = J_sim;
            for (size_t j_2__ = 0; j_2__ < X_beta_sim_j_2_max__; ++j_2__) {
                for (size_t j_1__ = 0; j_1__ < X_beta_sim_j_1_max__; ++j_1__) {
                    X_beta_sim(j_1__, j_2__) = vals_r__[pos__++];
                }
            }
            ...
            for (size_t i_0__ = 0; i_0__ < sp_sim_i_0_max__; ++i_0__) {
                ...
                check_less_or_equal(function__, "sp_sim[i_0__]", sp_sim[i_0__], J_sim);
            }
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("alpha_sim");
        names__.push_back("beta_sim");
    }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_w_sim_best_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            validate_non_negative_index("alpha_sim", "J_sim", J_sim);
            Eigen::Matrix<double, Eigen::Dynamic, 1> alpha_sim(J_sim);
            stan::math::initialize(alpha_sim, DUMMY_VAR__);
            stan::math::fill(alpha_sim, DUMMY_VAR__);
            current_statement_begin__ = 292;
            validate_non_negative_index("beta_sim", "J_sim", J_sim);
            Eigen::Matrix<double, Eigen::Dynamic, 1> beta_sim(J_sim);
            stan::math::initialize(beta_sim, DUMMY_VAR__);
            stan::math::fill(beta_sim, DUMMY_VAR__);
            // generated quantities statements
            current_statement_begin__ = 294;
            stan::math::assign(alpha_sim, param(b_alpha, X_alpha_sim, P_alpha_sim, J_sim, pstream__));
            current_statement_begin__ = 295;
            stan::math::assign(beta_sim, param(b_beta, X_beta_sim, P_beta_sim, J_sim, pstream__));
            current_statement_begin__ = 296;
            stan::math::assign(mT_sim, weibull_best_sim_rng(N_sim, m0_sim, time_sim, beta_sim, alpha_sim, sp_sim, base_rng__, pstream__));
            ...
            current_statement_begin__ = 291;
            size_t alpha_sim_j_1_max__ = J_sim;
            for (size_t j_1__ = 0; j_1__ < alpha_sim_j_1_max__; ++j_1__) {
                vars__.push_back(alpha_sim(j_1__));
            }
            current_statement_begin__ = 292;
            size_t beta_sim_j_1_max__ = J_sim;
            for (size_t j_1__ = 0; j_1__ < beta_sim_j_1_max__; ++j_1__) {
                vars__.push_back(beta_sim(j_1__));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t j_1__ = 0; j_1__ < alpha_sim_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "alpha_sim" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        size_t beta_sim_j_1_max__ = J_sim;
        for (size_t j_1__ = 0; j_1__ < beta_sim_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "beta_sim" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
    }
...
typedef model_w_sim_best_model_namespace::model_w_sim_best_model stan_model;
#ifndef USING_R
