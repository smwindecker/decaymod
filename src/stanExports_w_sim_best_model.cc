...
#include "stanExports_w_sim_best_model.h"

RCPP_MODULE(stan_fit4w_sim_best_model_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_w_sim_best_model")
