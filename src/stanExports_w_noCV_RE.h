...
namespace model_w_noCV_RE_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_w_noCV_RE");
    ...
    reader.add_event(159, 2, "restart", "model_w_noCV_RE");
    ...
    reader.add_event(238, 3, "restart", "model_w_noCV_RE");
    reader.add_event(302, 65, "end", "model_w_noCV_RE");
    return reader;
}
...
class model_w_noCV_RE
  : public stan::model::model_base_crtp<model_w_noCV_RE> {
private:
        int N;
        vector_d mT;
        vector_d m0;
...
public:
    model_w_noCV_RE(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_w_noCV_RE_namespace::model_w_noCV_RE";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_w_noCV_RE_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            stan::math::assign(alpha_fit, param_re(b_alpha, X_alpha, P_alpha, J, a_sp_alpha, pstream__));
            current_statement_begin__ = 297;
            stan::math::assign(beta_fit, param_re(b_beta, X_beta, P_beta, J, a_sp_beta, pstream__));
            current_statement_begin__ = 298;
            stan::math::assign(mT_sim, weibull_sim_rng(N_sim, m0_sim, time_sim, beta_fit, alpha_fit, sp_sim, base_rng__, pstream__));
...
typedef model_w_noCV_RE_namespace::model_w_noCV_RE stan_model;
#ifndef USING_R
