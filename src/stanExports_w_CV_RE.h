...
namespace model_w_CV_RE_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_w_CV_RE");
    ...
    reader.add_event(159, 2, "restart", "model_w_CV_RE");
    ...
    reader.add_event(238, 3, "restart", "model_w_CV_RE");
    reader.add_event(308, 71, "end", "model_w_CV_RE");
    return reader;
}
...
class model_w_CV_RE
  : public stan::model::model_base_crtp<model_w_CV_RE> {
private:
        int N;
        int N_test;
        vector_d mT;
        ...
        int J;
        matrix_d X_alpha;
        matrix_d X_alpha_test;
        matrix_d X_beta;
        matrix_d X_beta_test;
        std::vector<int> sp;
public:
    model_w_CV_RE(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_w_CV_RE_namespace::model_w_CV_RE";
        ...
        try {
            ...
            validate_non_negative_index("mT_test", "N_test", N_test);
            context__.validate_dims("data initialization", "mT_test", "vector_d", context__.to_vec(N_test));
            mT_test = Eigen::Matrix<double, Eigen::Dynamic, 1>(N_test);
            vals_r__ = context__.vals_r("mT_test");
            pos__ = 0;
            size_t mT_test_j_1_max__ = N_test;
            for (size_t j_1__ = 0; j_1__ < mT_test_j_1_max__; ++j_1__) {
                mT_test(j_1__) = vals_r__[pos__++];
            }
            ...
            validate_non_negative_index("m0_test", "N_test", N_test);
            context__.validate_dims("data initialization", "m0_test", "vector_d", context__.to_vec(N_test));
            m0_test = Eigen::Matrix<double, Eigen::Dynamic, 1>(N_test);
            vals_r__ = context__.vals_r("m0_test");
            pos__ = 0;
            size_t m0_test_j_1_max__ = N_test;
            for (size_t j_1__ = 0; j_1__ < m0_test_j_1_max__; ++j_1__) {
                m0_test(j_1__) = vals_r__[pos__++];
            }
            ...
            validate_non_negative_index("time_test", "N_test", N_test);
            context__.validate_dims("data initialization", "time_test", "vector_d", context__.to_vec(N_test));
            time_test = Eigen::Matrix<double, Eigen::Dynamic, 1>(N_test);
            vals_r__ = context__.vals_r("time_test");
            pos__ = 0;
            size_t time_test_j_1_max__ = N_test;
            for (size_t j_1__ = 0; j_1__ < time_test_j_1_max__; ++j_1__) {
                time_test(j_1__) = vals_r__[pos__++];
            }
            check_greater_or_equal(function__, "time_test", time_test, 0);
            ...
            validate_non_negative_index("X_alpha_test", "1", 1);
            validate_non_negative_index("X_alpha_test", "P_alpha", P_alpha);
            context__.validate_dims("data initialization", "X_alpha_test", "matrix_d", context__.to_vec(1,P_alpha));
            X_alpha_test = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(1, P_alpha);
            vals_r__ = context__.vals_r("X_alpha_test");
            pos__ = 0;
            size_t X_alpha_test_j_2_max__ = P_alpha;
            size_t X_alpha_test_j_1_max__ = 1;
            for (size_t j_2__ = 0; j_2__ < X_alpha_test_j_2_max__; ++j_2__) {
                for (size_t j_1__ = 0; j_1__ < X_alpha_test_j_1_max__; ++j_1__) {
                    X_alpha_test(j_1__, j_2__) = vals_r__[pos__++];
                }
            }
            ...
            validate_non_negative_index("X_beta_test", "1", 1);
            validate_non_negative_index("X_beta_test", "P_beta", P_beta);
            context__.validate_dims("data initialization", "X_beta_test", "matrix_d", context__.to_vec(1,P_beta));
            X_beta_test = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(1, P_beta);
            vals_r__ = context__.vals_r("X_beta_test");
            pos__ = 0;
            size_t X_beta_test_j_2_max__ = P_beta;
            size_t X_beta_test_j_1_max__ = 1;
            for (size_t j_2__ = 0; j_2__ < X_beta_test_j_2_max__; ++j_2__) {
                for (size_t j_1__ = 0; j_1__ < X_beta_test_j_1_max__; ++j_1__) {
                    X_beta_test(j_1__, j_2__) = vals_r__[pos__++];
                }
            }
            ...
            validate_non_negative_index("a_sp_alpha", "J", J);
            num_params_r__ += J;
            current_statement_begin__ = 264;
            validate_non_negative_index("a_sp_beta", "J", J);
            num_params_r__ += J;
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        current_statement_begin__ = 263;
        if (!(context__.contains_r("a_sp_alpha")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable a_sp_alpha missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("a_sp_alpha");
        pos__ = 0U;
        validate_non_negative_index("a_sp_alpha", "J", J);
        context__.validate_dims("parameter initialization", "a_sp_alpha", "vector_d", context__.to_vec(J));
        Eigen::Matrix<double, Eigen::Dynamic, 1> a_sp_alpha(J);
        size_t a_sp_alpha_j_1_max__ = J;
        for (size_t j_1__ = 0; j_1__ < a_sp_alpha_j_1_max__; ++j_1__) {
            a_sp_alpha(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_unconstrain(a_sp_alpha);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable a_sp_alpha: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 264;
        if (!(context__.contains_r("a_sp_beta")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable a_sp_beta missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("a_sp_beta");
        pos__ = 0U;
        validate_non_negative_index("a_sp_beta", "J", J);
        context__.validate_dims("parameter initialization", "a_sp_beta", "vector_d", context__.to_vec(J));
        Eigen::Matrix<double, Eigen::Dynamic, 1> a_sp_beta(J);
        size_t a_sp_beta_j_1_max__ = J;
        for (size_t j_1__ = 0; j_1__ < a_sp_beta_j_1_max__; ++j_1__) {
            a_sp_beta(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_unconstrain(a_sp_beta);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable a_sp_beta: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 265;
        ...
        current_statement_begin__ = 266;
        if (!(context__.contains_r("sigma_sp_alpha")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable sigma_sp_alpha missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("sigma_sp_alpha");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "sigma_sp_alpha", "double", context__.to_vec());
        double sigma_sp_alpha(0);
        sigma_sp_alpha = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, sigma_sp_alpha);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable sigma_sp_alpha: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 267;
        if (!(context__.contains_r("sigma_sp_beta")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable sigma_sp_beta missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("sigma_sp_beta");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "sigma_sp_beta", "double", context__.to_vec());
        double sigma_sp_beta(0);
        sigma_sp_beta = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, sigma_sp_beta);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable sigma_sp_beta: ") + e.what()), current_statement_begin__, prog_reader__());
        }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 263;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> a_sp_alpha;
            (void) a_sp_alpha;  // dummy to suppress unused var warning
            if (jacobian__)
                a_sp_alpha = in__.vector_constrain(J, lp__);
            else
                a_sp_alpha = in__.vector_constrain(J);
            current_statement_begin__ = 264;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> a_sp_beta;
            (void) a_sp_beta;  // dummy to suppress unused var warning
            if (jacobian__)
                a_sp_beta = in__.vector_constrain(J, lp__);
            else
                a_sp_beta = in__.vector_constrain(J);
            current_statement_begin__ = 265;
            ...
            current_statement_begin__ = 266;
            local_scalar_t__ sigma_sp_alpha;
            (void) sigma_sp_alpha;  // dummy to suppress unused var warning
            if (jacobian__)
                sigma_sp_alpha = in__.scalar_lb_constrain(0, lp__);
            else
                sigma_sp_alpha = in__.scalar_lb_constrain(0);
            current_statement_begin__ = 267;
            local_scalar_t__ sigma_sp_beta;
            (void) sigma_sp_beta;  // dummy to suppress unused var warning
            if (jacobian__)
                sigma_sp_beta = in__.scalar_lb_constrain(0, lp__);
            else
                sigma_sp_beta = in__.scalar_lb_constrain(0);
            // model body
            {
            ...
            lp_accum__.add(normal_log<propto__>(a_sp_alpha, 0, sigma_sp_alpha));
            current_statement_begin__ = 277;
            lp_accum__.add(normal_log<propto__>(a_sp_beta, 0, sigma_sp_beta));
            current_statement_begin__ = 278;
            lp_accum__.add(normal_log<propto__>(sigma_sp_alpha, 0, 2));
            current_statement_begin__ = 279;
            lp_accum__.add(normal_log<propto__>(sigma_sp_beta, 0, 2));
            ...
            stan::math::assign(alpha, param_re(b_alpha, X_alpha, P_alpha, J, a_sp_alpha, pstream__));
            current_statement_begin__ = 286;
            stan::math::assign(beta, param_re(b_beta, X_beta, P_beta, J, a_sp_beta, pstream__));
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("a_sp_alpha");
        names__.push_back("a_sp_beta");
        names__.push_back("sigma_obs");
        names__.push_back("sigma_sp_alpha");
        names__.push_back("sigma_sp_beta");
        names__.push_back("neg_loglik");
        names__.push_back("mT_pred");
    }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_w_CV_RE_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> a_sp_alpha = in__.vector_constrain(J);
        size_t a_sp_alpha_j_1_max__ = J;
        for (size_t j_1__ = 0; j_1__ < a_sp_alpha_j_1_max__; ++j_1__) {
            vars__.push_back(a_sp_alpha(j_1__));
        }
        Eigen::Matrix<double, Eigen::Dynamic, 1> a_sp_beta = in__.vector_constrain(J);
        size_t a_sp_beta_j_1_max__ = J;
        for (size_t j_1__ = 0; j_1__ < a_sp_beta_j_1_max__; ++j_1__) {
            vars__.push_back(a_sp_beta(j_1__));
        }
        double sigma_obs = in__.scalar_lb_constrain(0);
        vars__.push_back(sigma_obs);
        double sigma_sp_alpha = in__.scalar_lb_constrain(0);
        vars__.push_back(sigma_sp_alpha);
        double sigma_sp_beta = in__.scalar_lb_constrain(0);
        vars__.push_back(sigma_sp_beta);
        double lp__ = 0.0;
        ...
        try {
            ...
            validate_non_negative_index("mT_pred", "N_test", N_test);
            Eigen::Matrix<double, Eigen::Dynamic, 1> mT_pred(N_test);
            stan::math::initialize(mT_pred, DUMMY_VAR__);
            stan::math::fill(mT_pred, DUMMY_VAR__);
            // generated quantities statements
            {
            current_statement_begin__ = 298;
            local_scalar_t__ alpha_pred(DUMMY_VAR__);
            (void) alpha_pred;  // dummy to suppress unused var warning
            stan::math::initialize(alpha_pred, DUMMY_VAR__);
            stan::math::fill(alpha_pred, DUMMY_VAR__);
            current_statement_begin__ = 299;
            local_scalar_t__ beta_pred(DUMMY_VAR__);
            (void) beta_pred;  // dummy to suppress unused var warning
            stan::math::initialize(beta_pred, DUMMY_VAR__);
            stan::math::fill(beta_pred, DUMMY_VAR__);
            current_statement_begin__ = 301;
            stan::math::assign(alpha_pred, param_pred(b_alpha, X_alpha_test, P_alpha, pstream__));
            current_statement_begin__ = 302;
            stan::math::assign(beta_pred, param_pred(b_beta, X_beta_test, P_beta, pstream__));
            current_statement_begin__ = 303;
            stan::math::assign(mT_pred, weibull_pred_rng(N_test, m0_test, time_test, beta_pred, alpha_pred, sigma_obs, base_rng__, pstream__));
            current_statement_begin__ = 304;
            stan::math::assign(neg_loglik, weibull_negloglik(mT_pred, m0_test, time_test, beta_pred, alpha_pred, sigma_obs, N_test, pstream__));
            }
            // validate, write generated quantities
            current_statement_begin__ = 294;
            vars__.push_back(neg_loglik);
            current_statement_begin__ = 295;
            size_t mT_pred_j_1_max__ = N_test;
            for (size_t j_1__ = 0; j_1__ < mT_pred_j_1_max__; ++j_1__) {
                vars__.push_back(mT_pred(j_1__));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t j_1__ = 0; j_1__ < a_sp_alpha_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "a_sp_alpha" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        size_t a_sp_beta_j_1_max__ = J;
        for (size_t j_1__ = 0; j_1__ < a_sp_beta_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "a_sp_beta" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        param_name_stream__.str(std::string());
        ...
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "sigma_sp_alpha";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "sigma_sp_beta";
        param_names__.push_back(param_name_stream__.str());
        if (!include_gqs__ && !include_tparams__) return;
        ...
        if (!include_gqs__) return;
        param_name_stream__.str(std::string());
        param_name_stream__ << "neg_loglik";
        param_names__.push_back(param_name_stream__.str());
        size_t mT_pred_j_1_max__ = N_test;
        for (size_t j_1__ = 0; j_1__ < mT_pred_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "mT_pred" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
    }
...
typedef model_w_CV_RE_namespace::model_w_CV_RE stan_model;
#ifndef USING_R
