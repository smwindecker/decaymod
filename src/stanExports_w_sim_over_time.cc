...
#include "stanExports_w_sim_over_time.h"

RCPP_MODULE(stan_fit4w_sim_over_time_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_w_sim_over_time")
