...
namespace model_w_sim_over_time_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_w_sim_over_time");
    ...
    reader.add_event(159, 2, "restart", "model_w_sim_over_time");
    ...
    reader.add_event(238, 3, "restart", "model_w_sim_over_time");
    reader.add_event(300, 63, "end", "model_w_sim_over_time");
    return reader;
}
...
class model_w_sim_over_time
  : public stan::model::model_base_crtp<model_w_sim_over_time> {
private:
        int N;
        vector_d mT;
        vector_d m0;
...
public:
    model_w_sim_over_time(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_w_sim_over_time_namespace::model_w_sim_over_time";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_w_sim_over_time_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            stan::math::assign(mT_sim, weibull_sim_traits_rng(N_sim, m0_sim, time_sim, beta_sim, alpha_sim, sp_sim, base_rng__, pstream__));
...
typedef model_w_sim_over_time_namespace::model_w_sim_over_time stan_model;
#ifndef USING_R
