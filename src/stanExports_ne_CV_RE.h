...
namespace model_ne_CV_RE_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_ne_CV_RE");
    ...
    reader.add_event(89, 2, "restart", "model_ne_CV_RE");
    ...
    reader.add_event(168, 3, "restart", "model_ne_CV_RE");
    reader.add_event(222, 55, "end", "model_ne_CV_RE");
    return reader;
}
...
class model_ne_CV_RE
  : public stan::model::model_base_crtp<model_ne_CV_RE> {
private:
        int N;
        int N_test;
        vector_d mT;
        ...
        std::vector<int> sp;
public:
    model_ne_CV_RE(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_ne_CV_RE_namespace::model_ne_CV_RE";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_ne_CV_RE_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_ne_CV_RE_namespace::model_ne_CV_RE stan_model;
#ifndef USING_R
